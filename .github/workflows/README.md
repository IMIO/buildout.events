...
This repository uses GitHub Actions to build, publish, and deploy the Events Docker image across three environments: **dev**, **staging**, and **production**.
...
|----------|---------|---------|
| `IMAGE_NAME` | prod.yml | Docker image name (`web/smartweb/events`) |
