...
COPY --chown=imio --from=docker-staging.imio.be/smartweb/events:latest /plone/eggs/ /plone/eggs/
...
COPY --chown=imio delete_data_from_postgres.sh /plone/delete_data_from_postgres.sh
